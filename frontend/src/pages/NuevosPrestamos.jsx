...
export default function NuevosPrestamos() {
  ...
  // Vendedor eliminado: el sistema asigna automáticamente el empleado actual si corresponde
  ...
  // Eliminado preview de comisión vendedor
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Limpieza vendedor ya no necesaria
          ...
          <div className="card shadow-sm border-0">
            ...
            <div className="card-body p-4">
              <form onSubmit={handleSubmit}>
                ...
                {/* Sección de vendedor eliminada: el sistema asigna automáticamente el empleado actual si aplica */}
